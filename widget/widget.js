      ...
      .then(function(data) {
        if (data.status === "success") {
          ...
          noteDiv.innerHTML = "<strong>💰 SEÑA REQUERIDA:</strong><br>" +
            ...
            "<a href='https://wa.me/5492996037282?text=Comprobante%20de%20pago%20de%20seña' style='display:inline-block;padding:8px 14px;background:#25D366;color:white;border-radius:6px;text-decoration:none;margin-top:8px;font-weight:500;font-size:12px;'>📱 Enviar comprobante por WhatsApp</a>";
